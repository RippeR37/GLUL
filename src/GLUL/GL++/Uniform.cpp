...
namespace GL {
    ...
    // glUniform1_()
    template<> void Uniform::operator=(const GLfloat& value) const {
        glUniform1f(_location, value);
    }
    template<> void Uniform::operator=(const GLint& value) const {
        glUniform1i(_location, value);
    }
    template<> void Uniform::operator=(const GLuint& value) const {
        glUniform1ui(_location, value);
    }

    // glUniform2_v()
    template<> void Uniform::operator=(const glm::vec2& value) const {
        glUniform2fv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::ivec2& value) const {
        glUniform2iv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::uvec2& value) const {
        glUniform2uiv(_location, 1, glm::value_ptr(value));
    }

    // glUniform3_v()
    template<> void Uniform::operator=(const glm::vec3& value) const {
        glUniform3fv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::ivec3& value) const {
        glUniform3iv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::uvec3& value) const {
        glUniform3uiv(_location, 1, glm::value_ptr(value));
    }

    // glUniform4_v()
    template<> void Uniform::operator=(const glm::vec4& value) const {
        glUniform4fv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::ivec4& value) const {
        glUniform4iv(_location, 1, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::uvec4& value) const {
        glUniform4uiv(_location, 1, glm::value_ptr(value));
    }

    // glUniformMatrix_fv()
    template<> void Uniform::operator=(const glm::mat2& value) const {
        glUniformMatrix2fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat3& value) const {
        glUniformMatrix3fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat4& value) const {
        glUniformMatrix4fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }

    // glUniformMatrix_x_fv()
    template<> void Uniform::operator=(const glm::mat2x3& value) const {
        glUniformMatrix2x3fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat2x4& value) const {
        glUniformMatrix2x4fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat3x4& value) const {
        glUniformMatrix3x4fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat4x2& value) const {
        glUniformMatrix4x2fv(_location, 1, GL_FALSE, glm::value_ptr(value));
    }
    template<> void Uniform::operator=(const glm::mat4x3& value) const {
